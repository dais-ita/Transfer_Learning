...
file_pattern = 'dais_%s_*.tfrecord'
...
def get_split(split_name, dataset_dir, file_pattern=file_pattern):
    ...
    num_samples = 0
    file_pattern_for_counting = 'dais_' + split_name
...
def run():
    ...
    with tf.Graph().as_default() as graph:
        ...
        def train_step(sess, train_op, global_step, step):
            '''
        ...
        with sv.managed_session() as sess:
            ...
            # for step in xrange(1):
                ...
                #Log the summaries every 1000 step.
                if step % 100 == 0:
                    step = 1
                    loss, _ = train_step(sess, train_op, sv.global_step, step)
